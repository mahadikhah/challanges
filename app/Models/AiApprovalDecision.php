 ...
 *
 * `reason` and `raw_response` are display and audit data only. Nothing
 * anywhere may act on their contents (§2.8): they are never evaluated,
 * templated, or queried against.
 *
 * @property int $id
