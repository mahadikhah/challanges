...
return [
    ...
    /*
    | اسمی که آهنگ چالش با آن شمرده می‌شود — «هر روز»، «۱۰ هفته» — کلیدش با
    | `PeriodType` است و تنها از راه App\Services\Telegram\PeriodUnit خوانده
    | می‌شود. `period_type` بالا برچسب گزینش برای سازنده است («روزانه») و
    | چیزی کاملاً دیگر.
    |
    | در فارسی پس از عدد، اسم مفرد می‌آید (همان قاعده‌ای که بقیهٔ کاتالوگ
    | فارسی دارد)، پس `one` و `after_number` اینجا یکی‌اند؛ تفاوتشان در
    | انگلیسی است که پس از عدد جمع می‌خواهد. `custom` اسم خودش را ندارد:
    | آهنگ ۳ روزه با «روز» شمرده می‌شود.
    */
    'period_unit' => [
        'daily' => ['one' => 'روز', 'after_number' => 'روز'],
        'weekly' => ['one' => 'هفته', 'after_number' => 'هفته'],
        'monthly' => ['one' => 'ماه', 'after_number' => 'ماه'],
        'seasonal' => ['one' => 'فصل', 'after_number' => 'فصل'],
        'yearly' => ['one' => 'سال', 'after_number' => 'سال'],
        'custom' => ['one' => 'روز', 'after_number' => 'روز'],
    ],
